...
|===
h|Operation Name 4+e|GetAssetAdministrationShell
...
e|payload a|Requested Asset Administration Shell |yes |AssetAdministrationShell |1
|===
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|*Operation Name* 4+e|PutAssetAdministrationShell
h|Explanation 4+a|Replaces the Asset Administration Shell
h|*semanticId* 4+|`\https://admin-shell.io/aas/API/PutAssetAdministrationShell/3/0`

h|Name h|*Description* h|*Mand.* h|*Type* h|*Card.*
5+h|Input Parameter
e|aas a|AssetAdministrationShell |yes |Asset Administration Shell object |1
5+h|Output Parameter
e|statusCode a|StatusCode |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode]  |1
e|payload a|AssetAdministrationShell |yes |Replaced Asset Administration Shell |1
|===
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetAllSubmodelReferences
...
5+h|Output Parameter
e|statusCode a|Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
e|payload a|Requested Submodel References |yes |Reference |0..*
|===
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PostSubmodelReference
...
h|Name h| Description h|Mand. h|Type h|Card.
5+h|Input Parameter
e|submodelRef | Reference to the Submodel |yes |Reference |1
5+h|Output Parameter
e|statusCode | Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
e|payload | Created Submodel Reference |yes |Reference |1
|===
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|DeleteSubmodelReference
...
h|Name h| Description h|Mand. h|Type h|Card.
5+h|Input Parameter
e|submodelId | The unique id of the Submodel for the reference to be deleted |yes |Identifier |1
5+h|Output Parameter
e|statusCode | Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
|===
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetAssetInformation
...
5+h|Output Parameter
e|statusCode a|Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
e|payload a|Requested Asset Information |yes |AssetInformation |1
|===
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|*Operation Name* 4+e|PutAssetInformation
...
e|assetInfo a|Asset Information object |yes |AssetInformation |1
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetThumbnail
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PutThumbnail
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|DeleteThumbnail
...
e|PostSubmodelElement a|Creates a new submodel element as a child of the submodel. The idShort of the the new submodel element must be set in the payload.
e|PostSubmodelElementByPath a|Creates a new submodel element at a specified path within the submodel elements hierarchy. The idShort of the the new submodel element must be set in the payload.
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetSubmodel
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetAllSubmodelElements
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetSubmodelElementByPath
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetFileByPath
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PutFileByPath
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|DeleteFileByPath
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PutSubmodel
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PatchSubmodel
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PostSubmodelElement
h|Explanation 4+a|
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PostSubmodelElementByPath
h|Explanation 4+a|
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PutSubmodelElementByPath
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PatchSubmodelElementByPath
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetSubmodelElementValueByPath
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PatchSubmodelElementValueByPath
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|DeleteSubmodelElementByPath
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|InvokeOperationSync
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|InvokeOperationAsync
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetOperationAsyncStatus
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetOperationAsyncResult
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GenerateSerializationByIds
...
[cols="30%h,70%"]
|===
h|Enumeration: e|SerializationFormat
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetAllAASXPackageIds
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetAASXByPackageId
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PostAASXPackage
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PutAASXPackageById
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|DeleteAASXPackageById
...
These interfaces allow to register and unregister descriptors of administration shells or submodels. The descriptors contain the information needed to access the interfaces (as described in <<aas-interfaces>>) of the corresponding element. This required information includes the endpoint in the dedicated environment.

Lookup interfaces provide access to the registered descriptors by identifiers (Asset Administration Shell and Submodel ID). These identifiers may be discovered through the interfaces described in <<publish-and-discovery-interfaces>>.
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|CreateBulkAssetAdministrationShellDescriptors
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PutAssetAdministrationShellDescriptorById
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PutBulkAssetAdministrationShellDescriptorsById
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|DeleteAssetAdministrationShellDescriptorById
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|DeleteBulkAssetAdministrationShellDescriptorsById
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetAllSubmodelDescriptors
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetSubmodelDescriptorById
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PostSubmodelDescriptor
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|PutSubmodelDescriptorById
...
e|payload a|Replaced submodel descriptor |yes | xref:specification/interfaces-payload.adoc#SubmodelDescriptor[SubmodelDescriptor]  |1
|===
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|DeleteSubmodelDescriptorById
...
e|PostAssetAdministrationShell a|Creates a new Asset Administration Shell. The id of the new Asset Administration Shell must be set in the payload.
...
|serializationModifier |Defines the format of the response |yes |xref:specification/interfaces-operation-parameters.adoc#SerializationModifier[SerializationModifier]  |
|limit |The maximum size of the result set |no |nonNegativeInteger |1
|cursor |The position from which to resume a result listing |no |string |1
5+h|Output Parameter
|statusCode |Status code |yes |xref:specification/interfaces-payload.adoc#StatusCode[StatusCode] |1
...
h|Operation Name h|Description
e|GetAllSubmodels a|Returns all Submodels
e|GetSubmodelById a|Returns a specific Submodel
e|GetAllSubmodelsBySemanticId a|Returns all Submodels with a specific SemanticId
e|GetAllSubmodelsBySupplementalSemanticId |Returns all Submodels with a specific SupplementalSemanticId
e|GetAllSubmodelsByIdShort a|Returns all Submodels with a specific _idShort_
e|PostSubmodel a|
...
h|Explanation 4+a|Returns all Submodels with a specific SemanticId or SupplementalSemanticId. If either the semanticId fits to the input parameter or at least one of the SupplementalSemanticIds, the submodel is returned.
...
h|Explanation 4+a|Creates new asset identifier key-value-pairs linked to an Asset Administration Shell for discoverable content. The existing content might have to be deleted first.
...
[width=100%, cols="25%,35%,10%,20%,10%"]
|===
h|Operation Name 4+e|GetSelfDescription
